...
const Row = ({
  ...
  const checked = useMemo(() => {
    const isChecked = assignments[itemId]?.[keyActions] === true;
  ...
  const handleChange = useCallback(() => {
    handleCheckboxChange(item, keyActions);
    ...
    <StyledTableContainer1>
      <StyledTable stickyHeader>
        <StyledTableHead>
          <StyledTableRow>
            <StyledTableCellLarge>
              <StyledNameText>{titleName}</StyledNameText>
            </StyledTableCellLarge>
            <StyledTableCellMedium>
              <StyledNameTextHeader>{titleAction}</StyledNameTextHeader>
            </StyledTableCellMedium>
          </StyledTableRow>
        </StyledTableHead>
