...
import { AddButtonContainer, AddRowButton } from "@styles/index.stylescopy";

const DynamicTablePBMN = forwardRef(
  ({ defaultValue = [], disabled = false, configColumns = {} }, ref) => {
    ...
    // "Bắt buộc", "Tìm kiếm","Số ký tự tối thiểu", "Số ký tự tối đa", "Giá trị tối thiểu", "Giá trị tối đa",
            ...
            <DynamicTableHead>
              <DynamicTableRow>
                {tableHeaders.map((header, index) => (
                  <DynamicTableCellHead key={index}>
                    {header}
                  </DynamicTableCellHead>
                ))}
              </DynamicTableRow>
...
DynamicTablePBMN.defaultProps = {
  defaultValue: [],
  disabled: false,
  configColumns: {},
};

DynamicTablePBMN.displayName = "DynamicTableV3";
export default DynamicTablePBMN;
