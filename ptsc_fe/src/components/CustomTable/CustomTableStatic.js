...
// import { DOMPurify.sanitize } from "@/utils/securityUtils";
...
const CustomTable = ({
  ...
  const handleSwitchToCalendar = useCallback(() => {
    if (onSwitchView) onSwitchView('calendar');
  }, [onSwitchView]);
  ...
  const handleApplyFilterClick = useCallback((filters) => {
    ...
    setPage(0); // Reset về trang đầu khi áp dụng filter mới
    handleCloseFilter();
  }, [handleCloseFilter]);
  ...
  return (
    <>
      <StyleBoxTittle>
        ...
        <StyledPaper isMobieHeight={isMobieHeight} isInsideDialog={isInsideDialog} autoHeight={autoHeight} fixedHeight={fixedHeight} customMaxHeight={customMaxHeight} styledMaxHeight={styledMaxHeight} disablePaperHeight={disablePaperHeight} noPadding ={noPadding}>
          {!onlyTable && (
            <StyledToolbar>
              <ToolbarContent>
                {!disableSearch ? (
                ...
                <ActionsBox>
                  {selected.length > 0 && isSmallScreen ? (
                    <StyleBoxActionsRespon>
                      ...
                      {selected.length > 0 && !disableDeletePQ &&
                    ...
                    <>
                      ...
                      {moreActions && typeof moreActions === 'function' && moreActions()}
                    </>
                  )}
                </ActionsBox>
              </ActionsContainer>
          ...
          <StyleTableContainer isMaxHeight={isMaxHeight} customMaxHeight={customMaxHeight} autoHeight={autoHeight} disablePaperHeight={disablePaperHeight}>
            <StyledTable>
              {!disableHeader && (
                <StyledTableHead>
                  <StyledTableRow>
                  ...
                  {columns.map((column, idx) => {
                    ...
                    return (
                      ...
                      >
                        {(() => {
                          const labelValue = column.label || column.title || column.name;
                          const align = labelValue === "Trạng thái" ? "center" : "left";
                          return (
                            <HeaderCellContainer align={align}>
                              {labelValue}
                              <SortIconContainer>
                                <StyledArrowUp
                                  isActive={
              ...
              <TableBody>
                {data.length === 0 ? (
                  ...
                  data.map((row, index) => {
                    ...
                    const rowId = row.id || row._id;
                    const isPopoverOpen =
                      openPopoverId === rowId && Boolean(rowActionAnchorEl);
                    ...
                    return (
                      ...
                      >
                        {disableCheckbox ? (
                          ...
                          <CheckboxHeaderCell onClick={handlers.onCheckboxCellClick}>
                            <StyledCheckbox
                        ...
                        {columns.map((column) => {
                          ...
                          return (
                            <StyledTableCell
                              ...
                              styleTextAlign={(column.label || column.title || column.name) === "Trạng thái" ? "center" : "left"}
                            >
                          ...
                          >
                            ...
                            {(() => {
                              ...
                              // Nếu không có prop `actions`, render các nút mặc định
                                ...
                                if (typeof onAddItems === "function" && (typeof checkAddItemsCondition !== 'function' || checkAddItemsCondition(row))) {
                                  items.push({
                                    key: "addItems",
                                    title: "Thêm mới",
                                    icon: <Add />,
                                ...
                                if (
                                  ...
                                  (typeof checkEditCondition !== 'function' || checkEditCondition(row))
                                ) {
                                  items.push({
                                    key: "edit",
                                    title: "Cập nhật",
                                ...
                                if (
                                  ...
                                  (typeof checkViewCondition !== 'function' || checkViewCondition(row))
                                ) {
                                  items.push({
                                    key: "view",
                                    title: "Xem chi tiết",
                                ...
                                if (
                                  ...
                                  (typeof checkDeleteCondition !== 'function' || checkDeleteCondition(row))
                                ) {
                                  items.push({
                                    key: "delete",
                                    title: "Xóa",
