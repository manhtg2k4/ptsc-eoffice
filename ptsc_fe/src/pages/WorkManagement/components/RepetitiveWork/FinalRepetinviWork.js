...
const FinalRepetinviWork = ({ open, onClose, dataDetail, docId, setReloadData, onCloseDialog }) => {
    ...
    const handleConfirm = React.useCallback(async () => {
        ...
        try {
            ...
            if (response) {
                toast("Kết thúc công việc lặp thành công!", "success");
    ...
    return (
        ...
        >
            <SkyBox>
                <SkyTypography>
                    <b>Bạn có chắc chắn muốn</b> <HighlightText>Kết thúc lặp</HighlightText> <b>công việc có tên</b>{" "}
                    <HighlightText>“{dataDetail?.name}”</HighlightText> này?
                </SkyTypography>
                <SkyTypography>
                    <b>  Tác vụ này sẽ không thể hoàn tác</b>
                </SkyTypography>
            </SkyBox>
...
export default FinalRepetinviWork;