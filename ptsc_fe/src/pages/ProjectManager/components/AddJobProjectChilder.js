...
const AddJobProjectChilder = ({
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const response = await axiosInstance.post(`${API_ADD_COMMON_WORK}/child-from-project`, payload);
...
export default withSharedComponents(AddJobProjectChilder);