...
import MeetingScheduleCalendar from './components/MeetingScheduleCalendarHasSubmenu';
...
const MeetingCalendarHasSubmenu = ({ sharedComponents, ...props }) => {
...
export default withSharedComponents(MeetingCalendarHasSubmenu);
