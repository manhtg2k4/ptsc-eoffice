...
const Lookup = () => {
  ...
  const handleSearch = () => {
    ...
    setSearchTrigger(prev => prev + 1); // Trigger reload table
  };
  ...
  //     // await dispatch(deleteLookupData({ ids })).unwrap();
  ...
  return (
    <>
      ...
      {/* CustomTable hiển thị bên dưới */}
      <CustomTable
        columns={columnsSigningSubmission}
        onlyTable
        disableAct
        disableCheckbox
				encodeHtml
