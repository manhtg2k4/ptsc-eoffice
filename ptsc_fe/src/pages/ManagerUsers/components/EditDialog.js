...
const EditDialog = ({
  ...
  // Lấy giá trị của đơn vị đang chỉnh sửa từ form
  const unitId = control._defaultValues?._id;

  // Lọc danh sách đơn vị, bỏ chính nó ra
  const filteredUnits = listUnit?.filter((unit) => unit._id !== unitId) || [];
...
EditDialog.propTypes = {
  ...
  control: PropTypes.object.isRequired, // Sửa: control là object, không phải func
  handleSubmit: PropTypes.func.isRequired,
  errors: PropTypes.object.isRequired, // Sửa: errors là object, không phải func
