...
import { StyledTab, StyledTabs } from "@styles/Subtab.style";
...
const Subtab = ({
  ...
  const handleAddTab = () => {
    ...
    setTabs([
      ...tabs,
      { id: newId, label: `Tab ${tabs.length + 1}`, func: "" },
    ]);
        ...
        {editingTab && (
          <PopoverContent>
            ...
            <Select
              ...
              // onChange={(e) => handleConfigChange("func", e.target.value)}
              onChange={handleInputChange("func")}
            >
