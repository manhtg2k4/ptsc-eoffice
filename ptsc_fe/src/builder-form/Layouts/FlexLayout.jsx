...
export default function FlexLayout({
  ...
  const handleChangeProp = (propName, value) => {
    onPropChange(item.id, propName, value);
  };
  ...
  const getHandleChangeProp = (propName, isNumber = false) => (e) => {
    handleChangeProp(propName, isNumber ? Number(e.target.value) : e.target.value);
  };
        ...
        <ControlsContainer>
          ...
          <StyledFormControl size="small">
            ...
            <Select
              ...
              label="Direction"
              onChange={getHandleChangeProp('direction')}
            >
          ...
          <StyledFormControl size="small">
            ...
            <Select
              ...
              onChange={getHandleChangeProp('justifyContent')}
            >
          ...
          <StyledFormControl size="small">
            ...
            <Select
              ...
              label="Align Items"
              onChange={getHandleChangeProp('alignItems')}
            >
              <MenuItem value="flex-start">Start</MenuItem>
              <MenuItem value="flex-end">End</MenuItem>
              <MenuItem value="center">Center</MenuItem>
          ...
          <GapControlContainer>
            ...
            <GapInput
              ...
              onChange={getHandleChangeProp('gap', true)}
              inputProps={{ min: 0 }}
            />
          </GapControlContainer>
        </ControlsContainer>
