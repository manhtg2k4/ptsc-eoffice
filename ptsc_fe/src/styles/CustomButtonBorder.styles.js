...
export const StyledActionButton = styled(StyleButton, {
  ...
  // Mặc định là style outlined như thiết kế
  ...
  '&:hover': {
    backgroundColor: "rgba(0, 98, 173, 0.04)",
    borderColor: "#005191",
    color: "#005191",
  },
  ...
  // Nếu truyền variant='contained' thì đổi lại style
  ...(variant === 'contained' && {
...
export const StyledTableHead = styled(TableHead)(({ theme, isBgCl }) => ({
  '& th': {
    backgroundColor: isBgCl ? theme.palette.primary.main : theme.palette.background.default,
    color: theme.palette.primary.contrastText,
    fontWeight: 600,
    zIndex: 100,
  ...
  // Row 2 sticky top - set to 44px which is common for this row height to avoid overlapping or gaps
  '& tr:nth-of-type(2) th': {
    top: '53px !important',
    zIndex: 105, 
  }
...
export const StyledTableCellMedium = styled(TableCell)(({ theme, roleColor }) => ({
  width: "160px", // Fixed width for better sticky control
  minWidth: "160px",
  padding: "4px !important",
  textAlign: "center",
  position: "sticky",
  ...
  // Specific sticky positions from right
  "&:nth-last-of-type(1)": {
    right: 0,
    zIndex: 10,
  },
