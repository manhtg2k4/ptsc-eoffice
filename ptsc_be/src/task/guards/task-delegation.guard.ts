...
@Injectable()
export class TaskDelegationRolesGuard implements CanActivate {
  constructor(
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (!hasAccess) {
      throw new ForbiddenException('Bạn không có quyền quản lý ủy quyền giao việc. Chỉ dành cho Trưởng phòng, Phó trưởng phòng, Giám đốc, Phó giám đốc.');
    }
